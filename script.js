...
playerLeft.src = 'https://i.ibb.co/DQ3qgSF/father.png';
const playerRight = new Image();
playerRight.src = 'https://i.ibb.co/DQ3qgSF/father.png';
...
class Player {
    constructor(){
        ...
        this.frameY = 0;
        this.frame = 0;
        this.spriteWidth = 249;
        this.spriteHeight = 776;
    }
    update(){
...
bubble.src = 'https://i.ibb.co/CHf4VTF/maize.png';
class Bubble {
    constructor(){
